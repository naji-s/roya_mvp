...
try:
    ...
    print("Recognition thinks you said: " + r.recognize_google(audio))
except sr.UnknownValueError:
...
# try:
#     print("api.ai thxinks you said " + r.recognize_api(audio, client_access_token=API_AI_CLIENT_ACCESS_TOKEN))
# except sr.UnknownValueError:
